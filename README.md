 ...
 * [`2018` = `2018.20220613`](https://github.com/munepi/docker-tllangjapanese/blob/20220613/Dockerfile): TeX Live 2018 frozen (`x86_64-linux`, `aarch64-linux`)
 ...
 * [`latest` = `20220613`](https://github.com/munepi/docker-tllangjapanese/blob/20220424/Dockerfile): based on `debian:bullseye-slim` (`linux/amd64`, `linux/arm64`)
